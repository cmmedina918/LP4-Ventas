 ...
 * @author DELL
 */
public class frmBuscarMarcas extends javax.swing.JFrame {
    ...
    void mostrar (String buscar){
        try {
            ...
            marcaController fun = new marcaController();
    ...
    private void initComponents() {
        ...
        getContentPane().add(pBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(6, 18, 460, 435));
    ...
    private void tblRegistroMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblRegistroMousePressed
        if (evt.getClickCount()==2) {
            ...
            frmProductos.txtIdMarca.setText(cod);
            frmProductos.txtMarca.setText(valor);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmBuscarMarcas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmBuscarMarcas().setVisible(true);
            }
        });
    }
