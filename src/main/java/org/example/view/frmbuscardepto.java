 ...
 * @author DELL
 */
public class frmbuscardepto extends javax.swing.JFrame {
    ...
    private void tblRegistroMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblRegistroMousePressed
        if (evt.getClickCount()==2) {
            ...
            frmciudad.txtiddepto.setText(cod);
            frmciudad.txtdepartamento.setText(valor);
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmbuscardepto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmbuscardepto().setVisible(true);
            }
        });
    }
