...
import org.example.controller.detFacturaController;
 ...
 * @author DELL
 */
public class frmDetFactura extends javax.swing.JFrame {

    private static String idCab;
    /**
     * Creates new form frmpaises
     */
    public frmDetFactura(String id) {
        idCab = id;
        initComponents();
        mostrar("",id);
        mirar();
    ...
    void mostrar (String buscar, String id){
        try {
            DefaultTableModel modelo;
            detFacturaController fun = new detFacturaController();
            modelo = fun.mostrar(buscar,id);
    ...
    private void initComponents() {
        ...
        pNuevo.add(txtIdProducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 50, 40, -1));
        ...
        pNuevo.add(txtProducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 50, 110, -1));

        btnmostrar.setText("Producto");
    ...
    private void txtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyReleased
        // TODO add your handling code here:
        mostrar(txtBuscar.getText(), idCab);
...
//                dts.setId_ciudad(Integer.parseInt(txtIdProducto.getText()));
...
//                fun.ocultar(dts);
    ...
    private void tblRegistroMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblRegistroMouseClicked
        ...
        txtIdProducto.setText(tblRegistro.getValueAt(fila, 1).toString());
        txtProducto.setText(tblRegistro.getValueAt(fila, 2).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmDetFactura.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmDetFactura(idCab).setVisible(true);
            }
        });
    }
