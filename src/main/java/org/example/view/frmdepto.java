 ...
 * @author DELL
 */
public class frmdepto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pNuevo.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, 100, -1));
        ...
        pNuevo.add(txtdepto, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 90, 150, -1));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel5.setText("Los campos con asterisco (*) son obligatorios");
        pNuevo.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 250, 280, -1));
        ...
        pNuevo.add(txtidpais, new org.netbeans.lib.awtextra.AbsoluteConstraints(96, 52, 40, -1));

        jLabel8.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel8.setText("Pais:");
        pNuevo.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(14, 55, 76, -1));
        ...
        pNuevo.add(txtpais, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 50, 110, -1));

        btnmostrar.setText("Paises");
        btnmostrar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnmostrarActionPerformed(evt);
            }
        });
        pNuevo.add(btnmostrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 50, -1, -1));
    ...
    public boolean validar(){
            if (txtdepto.getText().equals("")) {
                ...
                txtdepto.setBackground(Color.red);
                return false;
            } else {
                return true;
            }
    ...
    private void tblRegistroMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblRegistroMouseClicked
        ...
        txtidpais.setText(tblRegistro.getValueAt(fila, 1).toString());
        txtdepto.setText(tblRegistro.getValueAt(fila, 2).toString());
        txtpais.setText(tblRegistro.getValueAt(fila, 3).toString());
    ...
    private void btnmostrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnmostrarActionPerformed
        frmbuscarpais form = new frmbuscarpais ();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmdepto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public static javax.swing.JTextField txtidpais;
